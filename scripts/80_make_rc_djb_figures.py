...
def main() -> None:
    ...
    _set_style()
    make_architecture_figure(output_dir / "rc_djb_architecture.pdf")
    make_pareto_frontier(output_dir / "rc_djb_pareto_frontier.pdf")
    make_data_temporal_audit(output_dir / "rc_djb_data_temporal_audit.pdf")
    make_bridge_vector_field(output_dir / "rc_djb_bridge_vector_field.pdf")
    make_rank_decile_ribbons(output_dir / "rc_djb_rank_decile_ribbons.pdf")
    make_bridge_delta_ridges(output_dir / "rc_djb_bridge_delta_ridges.pdf")
    make_firewall_audit(output_dir / "rc_djb_firewall_audit.pdf")
    make_bridge_activation_ladder(output_dir / "rc_djb_bridge_activation_ladder.pdf")
    make_monthly_rank_heatmap(output_dir / "rc_djb_monthly_rank_heatmap.pdf")
