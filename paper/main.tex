...
volume, and uncertainty, while the return firewall prevents high-dimensional text from directly
...
return firewall is an architectural and predictive constraint, not structural causal identification
\citep{rubin1974estimating,imbens2015causal}.
